...
const person = [
    {name: "Hải" , age : 24 , address : "Quảng Bình"},
    {name: "Nam" , age : 25 , address : "Nghệ An"},
    {name: "Hậu" , age : 26 , address : "Thanh Hóa"}
];
let [hai,nam,hau] = person;
console.log(hai.name);
console.log(hai.age);
console.log(nam.name);
console.log(nam.age);
console.log(hau.name);
console.log(hau.age);
...
let book = {
    title: "Thế giới ngầm",
    author: "Đinh Thanh Hải",
    pages: 400,
    info() {
        console.log(`Cuốn sách : ${this.title} ; Được viết bởi tác giả : ${this.author} ; Gồm có : ${this.pages} trang`);
    }
}
book.info();
